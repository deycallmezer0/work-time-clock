...
describe('PaycheckCalculator', () => {
  ...
  it('renders correctly and calculates paycheck', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('Overtime Hours: 5.00')).toBeInTheDocument();
      expect(screen.getByText('Regular Pay: $800.00')).toBeInTheDocument();
      expect(screen.getByText('Overtime Pay: $150.00')).toBeInTheDocument();
